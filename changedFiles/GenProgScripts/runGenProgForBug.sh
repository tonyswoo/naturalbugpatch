...
if [ -d "$GP4J_HOME" ]; then
  ...
  #sudo update-java-alternatives -s $DIROFJAVA7
    ...
    $SCRIPTS/prepareBug.sh $PROJECT $BUGNUMBER $OPTION $TESTSUITESAMPLE $BUGSFOLDER $DIROFJAVA7 $DIROFJAVA8 $SAMPLENEGTESTS $NEGTESTPATH $SAMPLEPOSTESTS $POSTESTPATH $ENTROPY $FAULTLOC
